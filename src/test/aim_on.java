...
public class aim_on {
	...
	/*
	 * TODO:
	 * 1)recuperare le informazioni dal sorgente della mappa
	 * 2)lavorare il campo src in modo da estrapolare dalla stringa le informazioni
	 *   setviewcenterx, setviewcentery, setviewscale, setdisplayheight e setdisplaywidth
	 *  3) restituire 2 interi x e y relativi al pixel della mappa sul quale si trova l'elemento cercato.
	 *  
	 */
